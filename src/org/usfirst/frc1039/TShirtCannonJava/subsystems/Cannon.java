...
public class Cannon extends Subsystem {
    ...
    public void zeroBarrels(){
    	...
    	do{
    	rotate();
    	System.out.println(shooterEncoder.getRaw());
    ...
    public void shoot(){
    	...
    	if(isCharged){
        	System.out.println("Charged:a");
    		light.set(Relay.Value.kOff);
        	System.out.println("Charged:b");
        	shootSolenoid.set(true);
        	System.out.println("Charged:c");
    		Timer.delay(0.001);
        	System.out.println("Charged:d");
    		shootSolenoid.set(false);
        	System.out.println("Charged:e");
    		isCharged = false;
    	}
    }
    public void rotate(){
    	...
    	System.out.print(" ");
    	System.out.println(barrelLocator.get());
    	System.out.print(" ");
    	...
    	currentBarrel = (int) shooterEncoder.get();
    }
    ...
    public void nextBarrel(){
    	...
    	System.out.print(" CurrentBarrel: ");
    	System.out.print(currentBarrel);
    	rotate();
    	if(shooterEncoder.get() == currentBarrel + 40){
    		reachedNextBarrel = true;
    		barrelRotator.set(0);
    		barrelExtender.set(false);
    	}
